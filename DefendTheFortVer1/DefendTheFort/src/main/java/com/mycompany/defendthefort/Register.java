...
public class Register {
    ...
    public String toString(){
        ...
        for(int i = 0; i<attacked.size(); i++){
            attackedStr += "entidad: " + entity.nombre + "con un daño hecho: " + damageDone.get(i) + "\n";
        }
       String receivedStr = "";    
       for(int i = 0; i<attackers.size(); i++){
            receivedStr += "entidad: " + entity.nombre + "con un daño hecho: " + damageDone.get(i) + "\n";
        }  
       return("La entidad:  " + ID + "que empezó con vida" + startingLife + " ha registrad los siguientes ataques: \n" + attackedStr + damageReceived + "\n" + "y termino con vida: " + finalLife);
    }
